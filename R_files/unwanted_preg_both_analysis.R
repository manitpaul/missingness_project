# Unwanted pregnancy analysis (both-sided tests)
# ----------------------------------------------

source("R_files/CSA_both_analysis.R")
...
run_unwanted_preg_both_analysis <- function(
  data_dir = "Unwanted_pregnancy_data",
  alpha = 0.05,
  gamma_search_grid = seq(1, 5, by = 0.1),
  output_csv = "PDF_images/unwanted_preg_both_results.csv",
...
# Example usage:
# tab <- run_unwanted_preg_both_analysis(
#   data_dir = "Unwanted_pregnancy_data",
#   alpha = 0.05,
#   gamma_search_grid = seq(1, 5, by = 0.1),
#   output_csv = "PDF_images/unwanted_preg_both_results.csv",
